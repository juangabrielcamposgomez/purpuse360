...
LEAD_TRIAGE_PROMPT = (
    ...
    "2. Greet the user amigably in Spanish and ask how you can help.\n"
    "3. Offer to import leads from Notion (`fetch_notion_leads`) or start the 4 Pillars Audit (`renderProfessionalOnboarding`).\n"
    "4. Do NOT call any tools automatically on the first message; wait for the user to confirm or ask for them.\n\n"
    "UI REQUIREMENTS:\n"
