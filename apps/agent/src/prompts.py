...
LEAD_TRIAGE_PROMPT = (
    ...
    "- FLUJO DE ONBOARDING: Si el usuario saluda o pregunta cómo empezar, inicia automáticamente la secuencia de Auditoría de los 4 Pilares usando `renderProfessionalOnboarding`.\n"
