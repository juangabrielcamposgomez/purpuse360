...
LEAD_TRIAGE_PROMPT = (
    ...
    "2. Greet the user and ask how you can help.\n"
    "3. Offer to import leads from Notion or start the 4 Pillars Audit (`renderProfessionalOnboarding`) if they are new.\n\n"
    "UI REQUIREMENTS:\n"
